...
export declare class BehaviorAPIFactory {
    static variableObjectFactory: {
        ...
        Basis: () => Basis;
        VertexBuffer: (props?: Partial<Pick<VertexBuffer, "end" | "load" | "copy" | "unload" | "name" | "begin" | "vertexCount" | "primitiveType" | "isDynamic" | "attributes" | "indices" | "setAttribute" | "dirtifyAttribute" | "updateBufferDatas" | "bindBuffers" | "draw" | "bindAttributes" | "unbindAttributes" | "hasAttribute">> | undefined) => VertexBuffer;
