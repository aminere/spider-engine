...
export declare type SerializedObjectType = SerializedObject | SerializedPrefab | SerializedScene | SerializedAnimationTrack | SerializedNumberTrack | SerializedGamepadData;
export interface SerializedAssetReference {
    typeName: string;
    id: string;
}
export declare type SerializedPropertyType = SerializedArrayProperty | SerializedReference | SerializedReferenceArray | SerializedAssetReference | SerializedAssetReferenceArray | SerializedAsset | SerializedVertexBuffer | SerializedUISize | SerializedSize | SerializedComponentReference | SerializedNativeArray;
